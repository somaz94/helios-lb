...
Thank you for your interest in contributing to Helios Load Balancer!
...
```bash
git commit -m "feat: add IP hash load balancing method"
```
...
Open an [issue](https://github.com/somaz94/helios-lb/issues) for questions or discussion.
