...
# OCI image labels
LABEL org.opencontainers.image.title="helios-lb" \
      org.opencontainers.image.description="Kubernetes L4 load balancer controller" \
      org.opencontainers.image.url="https://github.com/somaz94/helios-lb" \
      org.opencontainers.image.source="https://github.com/somaz94/helios-lb" \
